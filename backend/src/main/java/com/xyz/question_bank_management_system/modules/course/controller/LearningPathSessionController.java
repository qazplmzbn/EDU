...
@RestController @RequiredArgsConstructor public class LearningPathSessionController {
 ...
 @PostMapping("/api/v1/learning-path-sessions/{pathCode}/steps/{stepCode}/complete") @PreAuthorize("hasRole('STUDENT')") public ApiResponse<Map<String,Object>> complete(@PathVariable String pathCode,@PathVariable String stepCode){return ApiResponse.ok(service.completeStep(SecurityContextUtil.getUserId(),pathCode,stepCode));}
